  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Badge variant={"outline"}>Next Updated: {nextUpdateDistance}</Badge>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The salary ranges are in thousands of dollars.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={salaryData}>
                ...
                <Tooltip
                  content={({ active, payload, label }) => {
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-blue-500 border rounded-lg p-2 shadow-md">
                ...
                <Bar dataKey="median" name="Median Salary (K)" fill="#82ca9d" />
                <Bar dataKey="max" name="Max Salary (K)" fill="#ffc658" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
